...
addButton.addEventListener("click", function () {
    ...
    var selected = Array.prototype.slice.call(basketUl.querySelectorAll(".selected"));

    for (i = 0; i < selected.length; i++) {
        if (selected[i].classList.contains("selected")) {
            selected[i].querySelector(".badge-pill").textContent++;
        }
    }
}, false);
...
removeButton.addEventListener("click", function remove() {
    ...
    for (i = 0; i < selected.length; i++) {
        if (selected[i].classList.contains("selected") && (selected[i].querySelector(".badge-pill").textContent > 0)) {
            selected[i].querySelector(".badge-pill").textContent--;
        }
    }
...
//    var selectedA = Array.prototype.slice.call(basketUl.querySelectorAll(".selected"));
//    
//    console.log(selectedA.length);
//    for (i = 0; i <=selectedA.length; i++) {
//        if (fruits[i].classList.contains("selected") && orderedBasket[i].classList.contains("selected")) {
////            fruits[i].classList.toggle("selected");s
